...
- **Les quatre intitulés de la navigation latérale** — « Hébergement », « Restaurant », « Bar »,
  « Pressing » — et le retrait de « La réception » et « Les services », qui étaient des mots
  d'hôtel imposés aux autres métiers.
...
| Garder une chambre qui va se libérer | « **Garder la chambre** » / *Hold the room* · état : « **Tenue jusqu'à 16 h 25** » / *Held until 4:25 p.m.* ⛔ **« Réserver »** — le mot promettrait un engagement que **quinze minutes** ne portent pas, et il collerait à `RSV`, qui est un autre produit (cycle F7) avec ses arrhes, ses statuts et sa politique d'annulation. ⚠️ **La tenue court à partir de la LIBÉRATION de la chambre, pas de maintenant** : on tient celle qui va se libérer pour le client qui attend au comptoir. La durée vient de `heb.duree_garde_comptoir_minutes` — *un délai décidé dans un composant serait devenu une constante que personne ne rouvre* |
...
| Les rubriques de la navigation latérale | **Une rubrique par verticale, nommée par le MÉTIER de l'exploitant** : « **Hébergement** » / *Rooms*, « **Restaurant** » / *Restaurant*, « **Bar** » / *Bar*, « **Pressing** » / *Laundry*. ⛔ « **La réception** » et « **Les services** », qui formaient le classement du cycle F1 et ont été **retirés au cycle F3** : ce sont des mots d'**hôtel**. « La réception » n'a aucun sens pour un pressing, et « les services » désigne, vu de l'hôtel, tout ce qui n'est pas l'hébergement — soit exactement les métiers qu'on rangeait dessous. Le jour où le restaurant est l'activité principale d'un client, l'arborescence lui dit que son métier est un accessoire du nôtre. ⚠️ **Une rubrique dont le module est inactif n'existe pas** : pas d'intitulé vide, pas d'entrée atténuée — le classement par verticale rend « absent, jamais grisé » structurel (SC-014). ⛔ Jamais « module », « verticale » ni le code `HEBERGEMENT` : ce sont nos mots, pas les siens |
| La navigation sur téléphone | « **Ouvrir le menu** » / *Open the menu* et « **Fermer le menu** » / *Close the menu*. ⚠️ **Le mot est « menu », pas « navigation »** : c'est celui que tout le monde emploie sur un téléphone. ⚠️ Et le bouton d'ouverture occupe **le coin haut-gauche**, la seule position que l'œil cherche quand il veut sortir d'un écran — celle qu'occupait la marque avant le cycle F3 |
| L'accueil et la caisse dans la navigation | **Hors rubrique, et sans intitulé de groupe**. L'accueil est en **tête**, toujours, et n'exige aucune permission : c'est la sortie de secours de tous les écrans. La caisse est en **pied** : on encaisse une nuit, un plat et un pressing dans le même tiroir, donc elle n'appartient à aucune verticale. ⛔ « **Général** », « **Divers** », « **Autres** » — inventer un intitulé nommerait un regroupement qui n'existe pas |
...
| `conflit_occupation_suivante` (409) | « **Cette chambre est réservée à partir de {heure}.** » / *This room is booked from {time}.* — **suivie des chambres libres de la même catégorie**. ⛔ Un message générique est un défaut (cycle F3, `specs/005-reception-passage-note-planning/spec.md` **FR-017**) : c'est la différence entre un refus qu'Adjoua peut expliquer au client et un refus qu'elle contournera. L'heure vient de l'occupation suivante, jamais d'une constante |
...
| Annonce de persistance à la connexion *(implémentée au cycle F2)* | **Deux formulations, une par verdict**, et l'écran en rend **une** — jamais un troisième cas silencieux : « **Vous resterez connectée sur cet appareil.** » / *You will stay signed in on this device.* quand le stockage durable est accordé, « **Cet appareil peut vous redemander votre identifiant.** » / *This device may ask you for your ID again.* sinon, **suivie de ce qui reste possible** : « **Vous pourrez toujours entrer à nouveau : rien de ce que vous avez enregistré ne se perd.** » / *You will always be able to sign in again: nothing you have saved is lost.* ⚠️ **Elle est lue AVANT toute saisie**, jamais après coup : découvrir une déconnexion une heure plus tard, devant un écran qu'on n'a pas demandé, est exactement ce qu'elle ferme. ⛔ Jamais « stockage non persistant », « quota », ni « mode privé », qui sont des constats d'ingénieur — ils n'apprennent rien à quelqu'un debout à la réception |
| Refus hors ligne **de la connexion** *(cycle F2)* | Motif : **réemploi exact** de la formulation de classe C ci-dessus — « **Cette action nécessite internet.** » / *This action requires an internet connection.* Versant positif **propre à cet écran** : « **Vous entrerez dès que le réseau revient. Ce qui est déjà enregistré sur cet appareil n'est pas perdu.** » / *You will be able to sign in as soon as the connection is back. Anything already saved on this device is not lost.* ⚠️ **La seconde phrase ne dit pas « nous enregistrerons votre demande »**, et c'est le point : une entrée n'est **jamais** mise en file — elle donnerait une session que le serveur n'a jamais accordée. Annoncée **avant** la saisie (FR-012) : `compte` est de classe C |
| Titre et invite de l'écran de connexion *(cycle F2)* | « **Entrer** » / *Sign in* pour le titre **et pour le bouton** — jamais « Se connecter », qui décrit l'établissement d'un lien technique, ni « Connexion », qui nomme le mécanisme. L'invite dit d'où vient l'identifiant : « **Entrez l'identifiant que votre gérant vous a donné.** » / *Enter the ID your manager gave you.* — un exploitant ne crée pas son compte, il le reçoit. Le champ s'appelle « **Identifiant** » / *ID*, et son aide dit les deux formes acceptées : « **Votre numéro de téléphone ou votre adresse e-mail.** » / *Your phone number or your email address.* |
| Replier la barre « Vos activités » *(cycle F2)* | « **Réduire** » / *Collapse* quand elle est dépliée, « **Afficher** » / *Show* quand elle est repliée. ⚠️ **Le bouton nomme ce qu'il VA FAIRE**, jamais ce qu'on voit — « Vos activités » sur un bouton dirait le contenu et laisserait deviner l'effet. ⛔ Jamais « masquer », qui suggère qu'on cache quelque chose à quelqu'un, ni « fermer », qui ferait croire qu'on quitte |
| Accueil d'un compte **sans aucun établissement** *(cycle F2)* | « **Aucun établissement ne vous est rattaché. Demandez à votre gérant de vous en donner un : vous verrez alors ici ce qui vous attend.** » / *No establishment is linked to you yet. Ask your manager to add you to one: you will then see here what is waiting for you.* ⚠️ **Le cas est prévu par le modèle, pas accidentel** : le rattachement de l'administrateur éditeur est `null` (`compte_role.etablissement_id`). L'écran DIT ce qui manque — cinq cadres vides se liraient comme une panne de chargement, un bandeau rouge comme un défaut. ⛔ Jamais « aucune donnée », « rattachement nul » ni « portée vide », qui nomment la colonne ; jamais « contactez l'administrateur », qui désigne quelqu'un que l'exploitant ne connaît pas — c'est **son gérant** qui donne les accès |
| Troisième état du sélecteur d'établissement *(cycle F2)* | « **Mes {n} établissements** » / *My {n} establishments*, et son second segment « **Vue d'ensemble** » / *Overview*. ⚠️ **Le nombre est dans la phrase, jamais sous-entendu** : « Mes établissements » ne dit pas combien, et c'est précisément ce qu'un propriétaire regarde. ⛔ Jamais « tous les établissements » — la portée n'est pas universelle, elle est **celle de cette personne** : M. Koffi voit ses trois maisons, pas le parc de l'éditeur. Jamais « portée », qui est le mot de la colonne |
...
| Langue de l'interface | « **Langue** » / *Language*, et les deux valeurs s'écrivent **dans leur propre langue** : « Français » et « English ». Un anglophone qui ne lit pas le français doit pouvoir trouver son entrée sans la comprendre. ⚠️ **Dans la barre d'en-tête, le segment porte le CODE à deux lettres** — `FR`, `EN` — et le nom complet reste en infobulle et en libellé accessible *(cycle F2, sur constat de capture : les deux noms entiers occupaient le tiers de la barre et écrasaient « Passer la main » et l'identité)*. **Le nom complet demeure la forme de référence** partout où la place existe — un réglage d'établissement, un écran de préférences. ⛔ Jamais un drapeau, qui désigne un pays et non une langue ; jamais « localisation » ni « i18n » |
...
| Annonce d'installation *(implémentée au cycle F1)* | Le bandeau dit d'abord **ce qui est possible**, puis **ce qu'on y gagne** : « **Cette application peut être installée sur cet appareil.** » / *This application can be installed on this device.*, suivie de « **Installée, elle s'ouvre même sans réseau, sans barre d'adresse — et elle reçoit les alertes.** » / *Once installed, it opens even without a network, with no address bar — and it receives alerts.* ⚠️ **Elle dit « sans réseau », jamais « hors ligne »** : « hors ligne » est un nom d'état INTERNE, proscrit du visible par SC-022, et le test des catalogues l'a attrapé dans cette phrase même Sur WebKit, la première phrase devient « **Cet appareil n'affichera aucune invitation d'installation.** » / *This device will not show any install prompt.* ⚠️ **Elle dit « n'affichera », pas « n'affiche pas encore »** : l'invitation ne viendra jamais, et laisser croire à une attente ferait attendre. L'accusé de réception est « **J'ai compris** » / *Got it*, et il range le bandeau **pour de bon sur cet appareil** — un bandeau permanent cesse d'être lu |
| Aide de la version nouvelle *(implémentée au cycle F1)* | « **Rechargez quand vous voulez : rien de ce que vous avez saisi n'est perdu.** » / *Reload whenever you like: nothing you have entered is lost.* ⚠️ **C'est la phrase qui décide si l'on recharge.** Sans elle, « une version nouvelle est prête » se lit comme une menace pour la saisie en cours, et l'on remet à plus tard — c'est-à-dire à jamais. Même construction que le refus hors ligne : l'annonce, puis ce qui reste vrai |
