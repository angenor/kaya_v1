...
| Seuil de déclenchement de la recherche client **par nom** (`heb.seuil_recherche_nom_caracteres`) | **3 caractères** — clé du catalogue, portée **ETABLISSEMENT**. En dessous, la recherche ne part pas : une lettre rendrait le fichier entier. Inscrite par le cycle **F3** le 2026-08-08 | SEJ-01 |
| Seuil de déclenchement de la recherche client **par numéro** (`heb.seuil_recherche_numero_chiffres`) | **4 chiffres** — clé du catalogue, portée **ETABLISSEMENT**. ⚠️ **Distinct du seuil par nom, et le motif est écrit** : trois lettres distinguent un nom, trois chiffres ne distinguent rien dans un fichier de numéros de téléphone — la liste rendue serait trop longue pour être lue. Inscrite par le cycle **F3** le 2026-08-08 | SEJ-01 |
