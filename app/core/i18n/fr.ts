...
export default {
  ...
  scenarios: {
    ...
    casDuJeu: 'Cas du jeu',
    casNominal: 'Nominal',
    casDense: 'Semaine dense',
    casComplet: 'Tout est pris',
    conflitAuTap: 'Conflit de disponibilité',
    issueEnvoiFiscal: 'Issue de l’envoi aux impôts',
    issueCertifiee: 'Validée',
    issueEchec: 'Refusée',
    issueIndeterminee: 'Sans réponse',
    deriveHorloge: 'Écart de l’horloge (secondes)',
    deriveHorlogeAide:
      'Positif : l’appareil avance. Négatif : il retarde. Les durées et les montants restent calculés sur l’heure du serveur.',
  ...
  passage: {
    ...
    rezDeChaussee: 'Rez-de-chaussée',
    etageInconnu: 'Sans étage',
    scannerLaPiece: 'Scanner la pièce',
    saisirTelephone: 'Saisir · téléphone',
    ...
    toutEstPris: 'Tout est pris pour le moment.',
    ceQuiSeLibere: 'Ce qui se libère',
    libreA: 'Libre à {heure}',
    garderPour: 'Garder pour {heure}',
    occupeeSeLibereA: 'Occupée — se libère à {heure}',
    tenueDeA: 'Tenue pour votre client, de {de} à {a}',
    garderLaChambre: 'Garder la chambre',
    tenueJusqua: 'Tenue jusqu’à {heure}',
  ...
  // ── La navigation latérale · présente partout ──────────────────────────────
  // ⚠️ ELLE EXISTE PARCE QU'UN ÉCRAN SANS SORTIE EST UN PIÈGE : arrivé sur la
  // vue du jour, on ne pouvait plus revenir à l'accueil.
  navigation: {
    titre: 'Aller à',
